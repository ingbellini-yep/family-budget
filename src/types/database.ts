export type Database = {
  public: {
    Tables: {
      ...
      accounts: {
        Row: { id: string; family_id: string; name: string; type: 'corrente' | 'carta' | 'investimento' | 'risparmio'; bank_name: string | null; color: string | null; icon: string | null; balance: number; created_at: string }
        Insert: { id?: string; family_id: string; name: string; type: 'corrente' | 'carta' | 'investimento' | 'risparmio'; bank_name?: string | null; color?: string | null; icon?: string | null; balance?: number; created_at?: string }
        Update: { id?: string; family_id?: string; name?: string; type?: 'corrente' | 'carta' | 'investimento' | 'risparmio'; bank_name?: string | null; color?: string | null; icon?: string | null; balance?: number; created_at?: string }
        Relationships: []
      }
      categories: {
      ...
      transactions: {
        Row: { id: string; family_id: string; account_id: string; category_id: string; date: string; amount: number; type: 'entrata' | 'uscita'; description: string; original_description: string | null; note: string | null; source: 'manuale' | 'pdf' | 'screenshot' | 'csv'; created_by: string; created_at: string }
        Insert: { id?: string; family_id: string; account_id: string; category_id: string; date: string; amount: number; type: 'entrata' | 'uscita'; description: string; original_description?: string | null; note?: string | null; source?: 'manuale' | 'pdf' | 'screenshot' | 'csv'; created_by: string; created_at?: string }
        Update: { id?: string; family_id?: string; account_id?: string; category_id?: string; date?: string; amount?: number; type?: 'entrata' | 'uscita'; description?: string; original_description?: string | null; note?: string | null; source?: 'manuale' | 'pdf' | 'screenshot' | 'csv'; created_by?: string; created_at?: string }
        Relationships: []
      }
      recurring_expenses: {
